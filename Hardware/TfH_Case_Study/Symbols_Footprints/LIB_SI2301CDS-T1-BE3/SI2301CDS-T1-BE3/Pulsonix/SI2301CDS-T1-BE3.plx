...
//13838648/1145810/2.50/3/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SI2301CDS-T1-BE3" (originalName "SI2301CDS-T1-BE3")
	...
	(compDef "SI2301CDS-T1-BE3" (originalName "SI2301CDS-T1-BE3") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SI2301CDS-T1-BE3"))
		...
		(attr "Mouser Part Number" "78-SI2301CDS-T1-BE3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Siliconix/SI2301CDS-T1-BE3?qs=CiayqK2gdcJNFARNd%252BC6jg%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "SI2301CDS-T1-BE3")
		(attr "Description" "MOSFET P-CHANNEL 20-V (D-S)")
		(attr "<Hyperlink>" "https://www.arrow.com/en/products/si2301cds-t1-be3/vishay?region=nac")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "SI2301CDS-T1-BE3.stp")
